      ...
      while ($p = mysqli_fetch_assoc($produk)) { ?>
        <div class="col-md-3 col-sm-6">
          <div class="card text-center p-3">
            <img src="../assets/images/<?= $p['gambar']; ?>" class="card-img-top mb-2" alt="<?= $p['nama_produk']; ?>">
...
function addToCart() {
  ...
  Swal.fire({
    title: 'Berhasil!', text: 'Barang berhasil ditambahkan ke keranjang!',
    icon: 'success', showConfirmButton: false, timer: 1500, timerProgressBar: true
  });
  setTimeout(() => { document.querySelector('form').submit(); }, 1600);
}
